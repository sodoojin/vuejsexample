...
var _store = require('./vue/store');

var _store2 = _interopRequireDefault(_store);

var _Messenger = require('./vue/components/Messenger.vue');

var _Messenger2 = _interopRequireDefault(_Messenger);

var _MessageAlert = require('./vue/components/MessageAlert.vue');
...
new _vue2.default({
    ...
    components: {
        ...
        MessageAlert: _MessageAlert2.default
    }
});

},{"./vue/components/MessageAlert.vue":11,"./vue/components/Messenger.vue":12,"./vue/store":16,"vue":4}],8:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.sendMessage = exports.getRecentMessage = undefined;
...
var getRecentMessage = exports.getRecentMessage = function getRecentMessage(_ref, offset) {
    var dispatch = _ref.dispatch;

    _message2.default.getRecentMessage(offset, function (message) {
        dispatch(types.RECENT_MESSAGE_RECEIVED, message);
    });
};

var sendMessage = exports.sendMessage = function sendMessage(_ref2, message, callback) {
    var dispatch = _ref2.dispatch;

    _message2.default.sendMessage(message, function (msg) {
        callback();
    });
};

},{"./api/message":10,"./mutation-types":15}],9:[function(require,module,exports){
'use strict';
...
exports.default = _vue2.default.http;

},{"vue":4,"vue-resource":3}],10:[function(require,module,exports){
'use strict';
...
exports.default = {
    getRecentMessage: function getRecentMessage(offset, cb) {
        _http2.default.get('/api/get_message.php?offset=' + offset).then(function (response) {
            cb(response.data.messages);
        });
    },
    sendMessage: function sendMessage(message, cb) {
        var formData = new FormData();
        formData.append('message', message);

        _http2.default.post('/api/write_message.php', formData).then(function (response) {
            cb(response.data);
        });
    }
};
...
exports.default = {
    vuex: {
        getters: {
            remained_messages: _getters.remained_messages
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<button v-show=\"remained_messages.length > 0\" type=\"button\" class=\"btn btn-primary\">\n    신규 메세지\n    <span class=\"badge\">\n        {{ remained_messages.length }}\n    </span>\n</button>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-87ac6826", module.exports)
  } else {
    hotAPI.update("_v-87ac6826", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../getters":13,"vue":4,"vue-hot-reload-api":2,"vueify/lib/insert-css":5}],12:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n")
'use strict';
...
exports.default = {
    ...
    methods: {
        send_message: function send_message() {
            ...
            this.sendMessage(this.user_message, function () {
    ...
    vuex: {
        ...
        actions: {
            getRecentMessage: _actions.getRecentMessage,
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-dc8a242a", module.exports)
  } else {
    hotAPI.update("_v-dc8a242a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../actions":8,"../getters":13,"vue":4,"vue-hot-reload-api":2,"vueify/lib/insert-css":5}],13:[function(require,module,exports){
"use strict";
...
var messages = exports.messages = function messages(state) {
    return state.messages.messages.map(function (message) {
        return message.content;
    });
};

var remained_messages = exports.remained_messages = function remained_messages(state) {
    var remained = state.messages.messages.filter(function (message) {
        return !message.read;
    });

    return remained.map(function (message) {
        return message.content;
    });
};
...
var mutations = _defineProperty({}, _mutationTypes.RECENT_MESSAGE_RECEIVED, function (state, message) {
...
},{"../mutation-types":15}],15:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var RECENT_MESSAGE_RECEIVED = exports.RECENT_MESSAGE_RECEIVED = 'RECENT_MESSAGE_RECEIVED';
var MESSAGE_SENT = exports.MESSAGE_SENT = 'MESSAGE_SENT';
...
},{"./modules/messages":14,"vue":4,"vuex":6}]},{},[7]);
